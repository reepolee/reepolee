 ...
 *
 * Assets are served flat at root (routes/studio/static/studio.js -> /studio.js),
...
export function discover_static_dirs(project_root: string): string[] {
	const static_dirs = [join(project_root, "static")];
	const routes_root = join(project_root, "routes");
