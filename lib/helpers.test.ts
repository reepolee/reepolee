...
describe("helpers", () => {
	...
	describe("route_namespace_from_dir edge cases", () => {
		test("throws for a path outside routes and mounted modules", () => expect(() => helpers.route_namespace_from_dir("/some/other/path")).toThrow("path is not under routes or a mounted route module"));
