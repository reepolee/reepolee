...
export function parse_pagination_params(url: string, default_limit = 20, extra_params: string[] = []): PaginationParams {
	...
	const result: PaginationParams = { query, offset, limit, order_by, filters, filter_not };
...
export function get_limit_options(current_limit: number | "all", allowed_limits: number[] = [
	...
	const options: (number | "all")[] = [...allowed_limits];
