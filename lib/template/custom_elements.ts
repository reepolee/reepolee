 ...
 */
export function preprocess_template(template: string, views_dir: string, ext: string, compile_slot: (content: string) => CompiledFn, component_include?: (tag_name: string) => string | null, project_root: string = dirname(views_dir)): PreprocessResult {
