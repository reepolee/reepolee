...
describe("object - deep_merge", () => {
	...
	test("deeply merges nested objects", () => {
		const target: Record<string, unknown> = { config: { theme: "dark", lang: "en" } };
...
describe("object - merge_fields", () => {
	test("merges generated fields with overrides", () => {
		...
		const overrides: any = { name: { attributes: { max_length: 200 } } };
		const result: any = obj.merge_fields(generated, overrides);
	...
	test("returns generated fields unchanged when no overrides", () => {
		const generated: any = { name: { type: "text" as const, name: "name", attributes: {} } };
...
describe("object - updated_diff", () => {
	...
	test("detects added keys", () => {
		...
		const updated: Record<string, unknown> = { a: 1, b: 2 };
