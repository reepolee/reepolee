...
/** "de-at" -> "de-at" (URL/filename form; the canonical form is already lowercase) */
...
/**
 * Resolve the locale whose UI strings (translations table) serve this
...
/** Locales that own translation rows (alias targets and unaliased locales). */
