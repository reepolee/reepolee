export type { db_routes_type } from "./schema.generated"; export { v_fields, fields, indexed_columns } from "./schema.generated";
...
const columns: Record<string, { width: string; class: string; domain?: string; filter?: boolean; grid?: boolean; localized?: boolean }> = {
	...
	"url": { width: "auto", class: "" },
	"table_name": { width: "20ch", class: "" },
	"module": { width: "15ch", class: "" },
	"removable": { width: "15ch", class: "text-center", domain: "boolean" },
