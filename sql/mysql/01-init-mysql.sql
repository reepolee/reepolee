...
CREATE TABLE translations (
    id          INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'ICU',
    locale        VARCHAR(10)  NOT NULL COMMENT 'ICU',
    ...
    display     VARCHAR(550) GENERATED ALWAYS AS (CONCAT_WS(':', locale, namespace, key_path)) VIRTUAL,
    created_at  TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at  TIMESTAMP    NULL ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uk_translations(locale, namespace, key_path)
) COMMENT '';
