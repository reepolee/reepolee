...
CREATE TABLE frameworks (
    ...
    author_id       INT UNSIGNED NOT NULL COMMENT 'ICUF',
    ...
    created_at      TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at      TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_frameworks_author_id FOREIGN KEY(author_id) REFERENCES authors(id) ON UPDATE CASCADE,
    CONSTRAINT fk_frameworks_reviewer_id FOREIGN KEY(reviewer_id) REFERENCES authors(id) ON UPDATE CASCADE,
...
INSERT IGNORE INTO frameworks (id, name, tagline, author_id, reviewer_id, language_id, first_commit_at, is_javascript) VALUES
