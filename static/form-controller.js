...
class FormController {
	...
	_bind_events() {
		...
		this.form_element.addEventListener("submit", async (e) => {
			// A submitter marked formnovalidate opts out of this controller
			// entirely (the locale copy buttons do). Let the browser submit
			// natively: form.submit() below ignores the submitter, which would
			// drop both its formaction and its name/value pair and post the
			// copy to the plain edit action instead.
