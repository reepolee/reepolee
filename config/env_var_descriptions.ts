...
export const ENV_VAR_DESCRIPTIONS: Record<string, string> = {
	...
	MAX_UPLOAD_SIZE_MB: "Upload size limit in MB, shared by image uploads and the json-to-sql tool. Required - missing or \"N/A\" fails loudly at the upload point rather than applying a silent default.",
