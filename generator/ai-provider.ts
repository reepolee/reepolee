...
const provider_checks = new Map<ActiveProvider, () => boolean>([
	["ollama", () => Boolean(Bun.env.OLLAMA_URL?.trim())],
	["gemini", () => Boolean(Bun.env.GEMINI_API_KEY?.trim())],
	["openai", () => Boolean(Bun.env.OPENAI_API_KEY?.trim())],
	["claude", () => Boolean(Bun.env.CLAUDE_API_KEY?.trim())],
	["xai", () => Boolean(Bun.env.XAI_API_KEY?.trim())],
	["huggingface", () => Boolean(Bun.env.HF_TOKEN?.trim())],
	["openrouter", () => Boolean(Bun.env.OPENROUTER_KEY?.trim())],
]);
