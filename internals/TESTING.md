...
bun run test:user             # User-facing tests only (lib/, routes/, config/, components/, server.test.ts, integration.test.ts)
...
- **Server tests** live at `server.test.ts` (project root) - user-facing, shipped.
